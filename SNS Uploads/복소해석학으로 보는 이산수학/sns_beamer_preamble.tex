...
\usepackage{geometry}
\geometry{papersize={160mm, 160mm}}
...
\setbeamertemplate{background canvas}{
    \begin{tikzpicture}[remember picture, overlay]
        \draw[line width=5mm, cyan] 
            (current page.south west) 
            rectangle 
            (current page.north east);
        \node[anchor=south east, font=\large\ttfamily, gray] 
            at ([shift={(-5mm,5mm)}]current page.south east) 
            {@\_tonextpage\_};
    \end{tikzpicture}
}
...
%%%%% TCBox - Corollary %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% usage:
%	\begin{cor}{Corollary Title}{Reference Keyword}
%		Text Here
%	\end{cor}
% reference:
%	\ref{cor:Reference Keyword}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\DeclareTcbTheorem[use counter from=dfn]{cor}{따름정리}{
	enhanced, breakable, left=4mm, right=4mm, top=4mm, bottom=2mm,
	colback=BurntOrange!5, coltitle=white, colframe=BurntOrange,
	before title={\,}, title={#1}, after title={\,}, fonttitle=\bfseries,
	attach boxed title to top left={xshift=4mm, yshift=-3.45mm},
